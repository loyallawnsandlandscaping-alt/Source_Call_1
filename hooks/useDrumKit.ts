...
// Complete 35-sound drum kit configuration with original sound names
const DEFAULT_DRUM_KIT: DrumKit = {
  ...
  sounds: [
    // All 35 sounds with original names, no categories
    {
      id: 'kick_1',
      name: 'kick_1',
      displayName: 'kick_1',
